...
public class GPUImageView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        Log.d("hj", "GPUImageView.init: surfaceType:" + surfaceType + "  isShowLoading:" + isShowLoading);
        gpuImage = new GPUImage(context);
        if (surfaceType == SURFACE_TYPE_TEXTURE_VIEW) {
            Log.d("hj", "GPUImageView.init: create  GPUImageGLTextureView");
            surfaceView = new GPUImageGLTextureView(context, attrs);
            gpuImage.setGLTextureView((GLTextureView) surfaceView);
        } else {
            Log.d("hj", "GPUImageView.init: create  GPUImageGLSurfaceView");
    ...
    private class GPUImageGLSurfaceView extends GLSurfaceView {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            if (forceSize != null) {
                Log.d("hj", "GPUImageGLSurfaceView.onMeasure: forceSize.width:" + forceSize.width + "   forceSize.height:" + forceSize.height);
